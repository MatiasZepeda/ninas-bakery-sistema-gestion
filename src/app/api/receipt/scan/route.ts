...
- Look for lines ABOVE or BELOW a product that show quantity info like "2 @ 1.89" or "2 @ $1.89" or "3 x 2.50"
- When a line says "2 @ 1.89" followed by a total of "3.78", that means: quantity=2, unit_price=1.89, total_price=3.78
- The number BEFORE the "@" is the quantity. The number AFTER the "@" is the unit_price
- The total shown on the right side of the receipt is total_price (quantity * unit_price)
- If there is NO "@ price" line, quantity=1 and the price shown is both unit_price and total_price
- All prices must be numbers (not strings), in the receipt's currency
- total_price = quantity * unit_price (always calculate this, verify it matches the receipt)
